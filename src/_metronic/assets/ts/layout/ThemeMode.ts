...
class ThemeMode {
    ...
    public getMode = (): Mode => {
        ...
        this.element?.getAttribute('data-bs-theme');
        return themeMode || defaultMode
    }
